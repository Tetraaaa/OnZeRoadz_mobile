                        ...
                        {                            
                            this.props.connected ?
                                <View style={{flexDirection:'row'}}>
                                    ...
                                    <Button color={Colors.primary} style={{ margin: 5, flex:15}} title={this.props.playable ? this.props.marker.progress ? Strings("circuitModal", "resume")  : Strings("circuitModal", "play")  : Strings("circuitModal", "download") } onPress={this.props.playable ? this.props.onPlay : () => this.props.onDownload(this.state.idLanguage)} />
                                </View>
                                :
                                null
                        }
