    ...
    render()
    {
        return (
            <View style={{ flex: 1 }}>
                ...
                <Button title="Connexion" onPress={this._login} color={Colors.secondaryDark} />
                <Text>Pas de compte ?</Text>
                <Button title="S'inscrire" onPress={() => { this.props.navigation.navigate("Signup") }} color={Colors.secondaryLight} />
            </View>
        );
    }
}
